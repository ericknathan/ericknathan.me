...
interface MessagesListFallbackProps {
  message: string;
}

export function MessagesListFallback({ message }: MessagesListFallbackProps) {
  return (
    <FadeIn
    ...
    >
      ...
      >
        <circle opacity="0.1" cx="75" cy="75" r="75" className="fill-primary" />
        <path
        ...
        <path
          ...
          className="fill-primary/90 animate-float delay-300"
        />
        <path
          ...
          className="fill-primary/80 animate-float delay-500"
        />
        <circle cx="25.5" cy="46.5" r="3.5" fill="#FEFEFE" className="animate-float" />
